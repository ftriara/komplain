    ...
    <table class="table table-striped table-dark table-bordered">
        ...
        <tbody class="table-hover">
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        <button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown"
                            aria-expanded="false" id="dropdownButton{{ $complain->id }}">
                            Diperbaiki
                        </button>
                ...
                <td>
                    <div class="col-md-10">
                        <input class="form-control" type="date" value="2021-06-18" id="tanggal_tindakan{{ $complain->id }}"
                            name="tanggal_tindakan" />
                    </div>
                </td>
                <td>
                    <div class="col-md-10">
                        <input class="form-control" type="date" value="2021-06-18" id="tanggal_selesai{{ $complain->id }}"
                            name="tanggal_selesai" />
                    </div>
                </td>
                <td>
                    <div class="mt-2 mb-3">
                        <select class="form-select form-select-lg" name="id_petugas" id="id_petugas{{ $complain->id }}">
                    ...
                    <div class="card-body">
                        <div class="demo-inline-spacing">
                            <form action="{{ route('admin.dataRiwayatTindakan.store') }}" method="post">
                                @csrf <!-- Tambahkan ini -->
                                <input type="hidden" name="id_komplain" value="{{ $complain->id }}">
                                <button type="submit" class="btn rounded-pill btn-primary" name="simpan">Simpan</button>
                            </form>
                        </div>
                    </div>
                </td>
